...
def edit_all_door_usage(geo_file, original, updated):
...
def edit_all_window_usage(geo_file, original, updated):
...
def edit_all_frame_usage(geo_file, original, updated):
...
def get_overheating_stats(cfg_file, res_file, out_file, query_point=25):
    # Read cfg file for list of zones
    _, _, _, _, _, _, zones = read_cfg(cfg_file)
...
def get_energy_balance(cfg_file, res_file, out_file=None):
    # Read cfg file for list of zones
    _, _, _, _, _, _, zones = read_cfg(cfg_file)
